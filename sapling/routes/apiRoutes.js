...
module.exports = function(app) {
  ...
  // (req, res) => {
  //   console.log("passport auth done");
  ...
  app.get("/api/walmart/:product", (req, res) => {
    ...
    axios
      .get("http://api.walmartlabs.com/v1/search?", { params })
      .then(result => {
        res.json(result.data);
      })
      .catch(err => {
  ...
  app.get("/api/walmart/product/:itemId", (req, res) => {
    ...
    axios
      .get(`http://api.walmartlabs.com/v1/items/${req.params.itemId}?`, {
        params
      })
      .then(result => {
        res.json(result.data);
  ...
  app.get("/api/walmart", (req, res) => {
    ...
    axios
      .get("http://api.walmartlabs.com/v1/trends?", { params })
      .then(result => {
        res.json(result.data);
      })
      .catch(err => {
  ...
  app.get("/api/bestbuy/product/:upc", (req, res) => {
    axios
      .get(
        `https://api.bestbuy.com/v1/products(upc=${req.params.upc}*)?format=json&apiKey=${process.env.BEST_BUY_API_KEY}`
      )
      .then(result => {
        res.json(result.data);
      })
